package com.assist7.remex.framework.base.service;
...
import com.assist7.july.utils.tolerant.TolerantUtils;
import com.assist7.remex.base.entity.Result;
import com.assist7.remex.base.exception.service.RemexServiceException;
import com.assist7.remex.framework.base.entity.page.Page;
import com.assist7.remex.framework.base.entity.page.PageCo;
 ...
 * @param <E>
 */
public class RemexBaseService<E> implements IRemexBaseService<E> {
	/**
	 * 日志记录器
	 */
